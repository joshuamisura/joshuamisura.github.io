function createMap(map){
	getMeteoriteData(map);
};

function getMeteoriteData(map){
	$.ajax("data/Meteorite_Landings_300.geojson", {
			dataType: "json",
...
function pointToLayer(feature, latlng, attributes){
    ...
    var attribute = attributes[4];console.log(attribute);
    ...
    var popupContent = "<p><b>Meteorite Name:</b> " + feature.properties.name + "</p>";

    //add formatted attribute to popup content string
    var mass = attribute;
    popupContent += "<p><b>Mass (g):</b> " + feature.properties[attribute]+"</p>";
